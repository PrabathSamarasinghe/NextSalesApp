...
export default function ProductSalesReport() {
  ...
  const fetchSalesData = async () => {
    ...
    const response = await fetch(`/api/invoice/salesreport?${params.toString()}`);
      if (!response.ok) {
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-100">
          <div className="px-6 py-5 border-b border-gray-200 bg-gray-50 rounded-t-lg">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-gray-800">Product Sales Report</h2>
          ...
          <div className="p-6">
            ...
            {/* Detailed Table */}
            <div>
              <h3 className="text-lg font-medium text-gray-800 mb-4">Detailed Sales Data</h3>
                  ...
                  {salesData.length > 0 && (
                    <tfoot className="bg-gray-50">
                      <tr>
                        ...
                        <td className="px-6 py-4 text-right font-medium text-gray-900">{totalQuantity}</td>
                        <td className="px-6 py-4 text-right font-bold text-gray-900">{formatCurrency(totalRevenue)}</td>
                        <td className="px-6 py-4 text-right font-medium text-gray-900">{totalInvoices}</td>
